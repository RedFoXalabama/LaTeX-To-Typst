...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \texttt{/src/latex\_parser/latex\_math.pest}
    \end{itemize}
...
%% TODO
    ...
    L'AST è dunque il formato individuato per costruire la \textbf{rappresentazione intermedia} del file sorgente.
...
%% TODO
    ...
    Se la precedente struttura ad albero era basata sulla grammatica, questa nuova struttura ad albero che andiamo a realizzare é basata su una lista di strutture ed enumerativi da noi definiti, nel file \textit{ast structure}, che vengono assegnati ai vari nodi in base alle loro regole grammaticali d'origine.
...
pub struct CommandNode {
    ...
    \end{verbatim}
    Gli attributi \texttt{optional\_args} e \texttt{required\_args} sono i vettori che contengono le rispettive liste di argomenti opzionali e obbligatori accettati dal comando, modellati da altre classi.
